...
#define XED_CPUID_BIT_AMX_FP16_DEFINED 1
...
#define XED_CPUID_BIT_AVX_IFMA_DEFINED 1
#define XED_CPUID_BIT_AVX_NE_CONVERT_DEFINED 1
#define XED_CPUID_BIT_AVX_VNNI_DEFINED 1
#define XED_CPUID_BIT_AVX_VNNI_INT8_DEFINED 1
...
#define XED_CPUID_BIT_CMPCCXADD_DEFINED 1
...
#define XED_CPUID_BIT_ICACHE_PREFETCH_DEFINED 1
...
#define XED_CPUID_BIT_MSRLIST_DEFINED 1
...
#define XED_CPUID_BIT_RAO_INT_DEFINED 1
...
#define XED_CPUID_BIT_WRMSRNS_DEFINED 1
...
typedef enum {
  ...
  XED_CPUID_BIT_AVX_IFMA,
  XED_CPUID_BIT_AVX_NE_CONVERT,
  XED_CPUID_BIT_AVX_VNNI,
  XED_CPUID_BIT_AVX_VNNI_INT8,
  XED_CPUID_BIT_BF16,
  XED_CPUID_BIT_BMI1,
  XED_CPUID_BIT_BMI2,
  XED_CPUID_BIT_CET,

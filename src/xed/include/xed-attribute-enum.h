...
#define XED_ATTRIBUTE_ATOMIC_DEFINED 1
...
#define XED_ATTRIBUTE_FIXED_ROUNDING_RNE_DEFINED 1
#define XED_ATTRIBUTE_FLUSH_INPUT_DENORM_DEFINED 1
#define XED_ATTRIBUTE_FLUSH_OUTPUT_DENORM_DEFINED 1
...
#define XED_ATTRIBUTE_REQUIRES_ALIGNMENT_4B_DEFINED 1
#define XED_ATTRIBUTE_REQUIRES_ALIGNMENT_8B_DEFINED 1
...
typedef enum {
  ...
  XED_ATTRIBUTE_FIXED_ROUNDING_RNE,
  XED_ATTRIBUTE_FLUSH_INPUT_DENORM,
  XED_ATTRIBUTE_FLUSH_OUTPUT_DENORM,
  ...
  XED_ATTRIBUTE_REQUIRES_ALIGNMENT_4B,
  XED_ATTRIBUTE_REQUIRES_ALIGNMENT_8B,
  XED_ATTRIBUTE_RING0,
